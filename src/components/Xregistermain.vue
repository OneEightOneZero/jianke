<template>
  <div data-v-5d26e834 class="register-box" :class="menu?'menu':''">
    <section data-v-5d26e834 class="page">
      <div data-v-5d26e834 class="tel-item">
        <input
          data-v-5d26e834
          type="tel"
          id="tel"
      ...
      <!---->
      <div data-v-5d26e834 class="code-item">
        <input
          data-v-5d26e834
          type="text"
          ...
          class="inputStyle"
        >
        <button data-v-5d26e834 class="code-btn" id="code">获取验证码</button>
        <button data-v-5d26e834 class="code-btn computing" style="display: none;">重新发送(0秒)</button>
        <!---->
      </div>
      <div data-v-5d26e834 class="password-item">
        <input
          id="psw"
          data-v-5d26e834
